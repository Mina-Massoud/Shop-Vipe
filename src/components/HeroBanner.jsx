    ...
    return (
      <SwiperSlide key={banner._id}>
        <div className="overflow-hidden  relative rounded mx-auto bg-[#ff000038] min-h-[250px] px-[3em] w-full lg:w-[85%] py-[3em] my-[3em]">
          <p className=" text-lg lg:text-2xl mx-[0.2em] font-bold">
            {banner.smallText}
          </p>
          <h2 className="text-4xl my-[0.2em] font-bold z-50 relative">
            {banner.midText}
          </h2>
          <img
            ...
            alt=""
          />
          <h1 className="text-5xl lg:text-[15rem] font-bold z-50 relative">
            {banner.largeText1}
          </h1>
          ...
          <div className="desc absolute right-[3em] bottom-[3em] max-w-[200px]">
            <p className="text-red-600 text-[1rem] lg:text-[1.2rem] font-bold">
              Description
            </p>
