...
export default function Header(props) {
  ...
  return (
    <div className="header sticky top-[0px] z-50 bg-black h-[81px] p-[2em] border-b-[1px] flex justify-between items-center">
      ...
      <div
        className={`left-side-header relative flex items-center ${
        ...
        {props.user[0] && props.user[0].length > 0 ? (
          <>
            <div
              ...
              className="user-profile mx-[1em] flex lg:border rounded-full items-center lg:max-w-[130px] flex-reverse"
            >
              <img
                src={
                  props.user[0][0].image ? props.user[0][0].image : profileImg
                }
                className="m-0 lg:ml-[1em] w-[50%] lg:w-[25%] rounded-full"
                alt=""
              />
              <h3 className="font-bold text-red-600 text-sm px-[20px] w-fit hidden lg:block">
                {props.user[0][0].userName}
              </h3>
              <div
                className={`absolute pop-login  bottom-[-94px] border w-[150px] bg-white ${
                  hover ? "pt-[1em]" : "p-0 m-0"
                } rounded`}
              >
                <ul>
                  <Link
                    ...
                    className="my-[4px] mx-auto w-fit text-black text-xl block p-[0.5em] hover:text-white transition rounded hover:bg-red-600 px-[2em]"
                  >
                    <li>Log out</li>
                  </Link>
                  <Link
                    to="/cart"
                    className="text-xl w-fit py-[0.4em] p-[0.5em] hover:text-white transition rounded hover:bg-red-600 px-[2em] block mx-auto text-black"
                  >
                    <li>My Cart</li>
                  </Link>
                </ul>
